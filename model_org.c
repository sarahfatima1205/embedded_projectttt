...
void run_inference(int8_t *input, int8_t *output)
{
    ...
    cmsis_nn_dims fc1_w_dims = {1, 1, 1, INPUT_SIZE};  // n=1 batch, output size comes from output_dims
    ...
    cmsis_nn_dims fc2_in_dims = {1, 1, 1, FC1_OUT};  // separate variable, same value
