...
void run_inference(const volatile int8_t *input, volatile int8_t *output)
{
    ...
    // These values come from #defines written by export.py into model_weights.h
    cmsis_nn_per_tensor_quant_params fc1_quant;
    fc1_quant.multiplier = FC1_QUANT_MULTIPLIER;
    fc1_quant.shift      = FC1_QUANT_SHIFT;

    cmsis_nn_dims input_dims   = {1, 1, 1, INPUT_SIZE};
    cmsis_nn_dims fc1_w_dims   = {1, 1, 1, INPUT_SIZE};
    ...
    fc2_quant.multiplier = FC2_QUANT_MULTIPLIER;
    fc2_quant.shift      = FC2_QUANT_SHIFT;

    cmsis_nn_dims fc2_in_dims  = {1, 1, 1, FC1_OUT};   // input to FC2
    cmsis_nn_dims fc2_w_dims   = {1, 1, 1, FC1_OUT};
    ...
    arm_fully_connected_s8(
        ...
        &fc2_params,
        &fc2_quant,
        &fc2_in_dims,        // <-- was wrongly &fc1_out_dims before
        relu_out,
        &fc2_w_dims,
